...
I have built six dossiers, available in the repository at `dossiers/`, documenting the financial and personnel networks among the actors whose interests the order affects. I will not restate the dossiers here; what I will do is name the structural conflict pattern, in the most general form that the primary sources support, and invite you to verify the specifics independently.

### The conflict pattern

A sitting president signed an executive order with provisions that materially benefit a stablecoin issuer in which his immediate family holds a contractual claim to seventy-five percent of protocol revenue. The president's Commerce Secretary's investment bank holds a five percent equity stake in the world's largest stablecoin issuer, which is also a direct beneficiary of the same order. The White House AI and Crypto Czar served as a Special Government Employee while holding (and divesting under an undisclosed ethics waiver) approximately two hundred million dollars in crypto positions. The administration's CFTC Chair nominee came from the largest crypto venture capital fund. The President of the second-largest stablecoin issuer is a former CFTC Chairman.
